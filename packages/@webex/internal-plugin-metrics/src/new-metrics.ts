...
class Metrics extends WebexPlugin {
  ...
  public submitClientEvent({
    ...
    const enrichedPayload = this.addPrivacyAndSecurityPermission({name, payload});
  ...
  private addPrivacyAndSecurityPermission({
    ...
    try {
      ...
      return projectedPermission
        ? {...payload, privacyAndSecurityPermission: projectedPermission}
        : payload;
    } catch (error) {
      // @ts-ignore
